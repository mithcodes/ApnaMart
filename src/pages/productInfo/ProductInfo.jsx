...
const ProductInfo = () => {
    ...
    return (
        <Layout>
            <section className="py-5 lg:py-10 font-poppins mt-20 ">
                {loading ?
                    <>
                            ...
                            <div className="flex flex-wrap mb-24 -mx-4">
                                <div className="w-full px-4 mb-8 md:w-1/2 md:mb-0">
                                    <div className="">
                                        <div className="">
                                            <img
                                                className=" w-full md:h-[25em] rounded-lg"
                                ...
                                <div className="w-full px-4 md:w-1/2">
                                    <div className="lg:pl-20">
                                        <div className="mb-6 ">
                                                    ...
                                                    <li>
                                                        <a href="">
                                                            <svg
                                                                ...
                                                                height={16}
                                                                fill="currentColor"
                                                                className="w-4 mr-1 text-red-500 dark:text-red-400 bi bi-star "
                                                                viewBox="0 0 16 16"
                                                            >
                                            ...
                                            <p className="inline-block text-2xl font-semibold text-gray-700 dark:text-black ">
                                                <span>₹ {product?.price}</span>
                                            </p>
                                        </div>
                                        <div className="mb-6">
                                            <h2 className="mb-2 text-lg font-bold text-black dark:text-black">
                                                Description :
                                            </h2>
